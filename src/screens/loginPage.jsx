...
import FallingPapers from '../components/fallingCharacters';
      ...
      <div className='content-box'>
        <div className='content1' style={{ color: 'white' }}>
          <div className='description'>
            ...
            <span><Cursor /></span>
            <p className='desc'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde tenetur quisquam dicta saepe recusandae repellendus suscipit, dolorem neque iure omnis ipsa cum voluptas! Vitae quisquam officiis magni magnam. Nam, excepturi.</p>
          </div>
